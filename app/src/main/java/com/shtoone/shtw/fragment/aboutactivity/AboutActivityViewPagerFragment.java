...
public class AboutActivityViewPagerFragment extends BaseFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (args != null) {
            aboutWhat = args.getInt("aboutwhat");
        }
    }
    ...
    public static AboutActivityViewPagerFragment newInstance(int position) {
        ...
        args.putInt("aboutwhat", position);
    ...
    private void initData() {
        ...
        if (aboutWhat == 0) {
            url = "http://note.youdao.com/yws/public/redirect/share?id=da6201c8b2593d91097abb0bf48a3593&type=false";
        } else if (aboutWhat == 1) {
            url = "http://note.youdao.com/yws/public/redirect/share?id=da6201c8b2593d91097abb0bf48a3593&type=false";
        }
