...
public class WannengjiFragment extends BaseFragment {
    ...
    private void initView(View view) {
        ...
        pageStateLayout = (PageStateLayout) view.findViewById(R.id.psl_wannengji_fragment);
...
//                startActivity(intent);
    ...
    private void setAdapter() {
        mViewPager.setAdapter(new WannengjiFragmentViewPagerAdapter(getChildFragmentManager(), mEquipmentData));
