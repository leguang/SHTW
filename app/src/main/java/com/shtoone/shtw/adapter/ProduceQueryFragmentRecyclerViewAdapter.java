...
public class ProduceQueryFragmentRecyclerViewAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    static class ItemViewHolder extends RecyclerView.ViewHolder {
        ...
        public ItemViewHolder(View view) {
            ...
            tv_datetime = (TextView) view.findViewById(R.id.tv_datetime_item_recyclerview_produce_query_fragment);
            tv_site = (TextView) view.findViewById(R.id.tv_site_item_recyclerview_produce_query_fragment);
            tv_project_name = (TextView) view.findViewById(R.id.tv_project_name_item_recyclerview_produce_query_fragment);
            tv_position = (TextView) view.findViewById(R.id.tv_position_item_recyclerview_produce_query_fragment);
            tv_location = (TextView) view.findViewById(R.id.tv_location_item_recyclerview_produce_query_fragment);
            tv_strength_grade = (TextView) view.findViewById(R.id.tv_strength_grade_item_recyclerview_produce_query_fragment);
            tv_count = (TextView) view.findViewById(R.id.tv_count_item_recyclerview_produce_query_fragment);
        }
    }
